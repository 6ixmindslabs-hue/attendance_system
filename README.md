...
Optional low-light / blur recovery tuning is available in [`ai-service/.env.example`](c:\Users\dhine\Desktop\ATTENDANCE_MANAGEMENT\ai-service\.env.example). The most useful knobs are:

- `ENABLE_CAPTURE_RECOVERY`
- `FACE_RECOVERY_MIN_BRIGHTNESS`
- `FACE_RECOVERY_MIN_BLUR_VARIANCE`
- `FACE_RECOVERY_TARGET_BRIGHTNESS`
- `FACE_RECOVERY_UNSHARP_AMOUNT`
