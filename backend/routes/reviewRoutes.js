...
import { createLocalTimestamp, getLocalDateBounds, isAfternoonPeriod } from '../services/attendanceSettingsService.js';
import { authenticateRequest, requireAdmin } from '../middleware/authMiddleware.js';
...
const resolveAttendanceTimestamp = (review) => {
    ...
    if (isAfternoonPeriod(review.period)) {
