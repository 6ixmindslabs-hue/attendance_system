...
router.get('/report', authenticateRequest, scopeAttendanceReportAccess, async (req, res) => {
    try {
        const {
            date,
            studentId,
...
router.post('/mark', authenticateRequest, requireAdmin, async (req, res) => {
    try {
...
router.post('/override', authenticateRequest, requireAdmin, async (req, res) => {
    try {
        const {
            studentId,
            date,
